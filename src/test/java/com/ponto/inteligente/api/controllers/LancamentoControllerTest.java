...
class LancamentoControllerTest {
	...
	@Test
	@WithMockUser
	void testCadastrarLancamento() throws Exception {
	...
	public void testCadastrarLancamentoFuncionarioIdInvalido() throws Exception {
		BDDMockito.given(this.funcionarioService.buscarPorId(Mockito.anyLong())).willReturn(Optional.empty()); //RETORNO VAZIO, FUNCIONÁRIO INVÁLIDO
	...
	private String obterJsonRequisicaoPost() throws JsonProcessingException {
		...
		//pega o valor e converte para um objeto json
